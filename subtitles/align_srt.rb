...
while true do
	...
	index_src += 1
	index_trg += 1
	if src_dic[index_src] == nil or trg_dic[index_trg] == nil
		break
	end
end
...
#	j = 0
#	row_diff = false
#	while src_array[i] != nil and trg_array[j] != nil do
#
#		if spid % 10000 == 0
...
#
#
#		if src_array[i] == "" and trg_array[j] == ""
#			write = true
#		elsif src_array[i] == ""
#			row_diff = true
